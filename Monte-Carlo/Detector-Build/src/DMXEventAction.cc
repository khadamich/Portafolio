  ...
  */
  ...
  if(S_hits) {
    ...
    */
	...
	//G4double sigmaE = (sqrt(edep*1000)*0.917538 - 3.72313);
	//G4double sigmaE = ResE*edep/2.355;
	//G4double sigmaE =
	G4double sigmaE = 2.0798 + 0.0363394*(edep*1000) - (1.4217e-5)*(edep*1000)*(edep*1000); 
