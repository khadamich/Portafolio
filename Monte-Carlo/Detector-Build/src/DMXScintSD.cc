  ...
  :G4VSensitiveDetector(name)
{
  ...
  //Info << "Particula  " << "Energia depositada " << std::endl;
...
G4bool DMXScintSD::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
 ...
 // G4cout << "Energia  "<< G4BestUnit(edep,"Energy")<<" Particula "  << particleName <<" Posicion  "<< G4BestUnit(posx,"Length") << G4endl;
  
  //Info << n <<" "<<particleName << "  " <<G4BestUnit(edep,"Energy") << std::endl;
