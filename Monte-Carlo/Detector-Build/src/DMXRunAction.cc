...
{  
  ...
  man->CreateNtupleDColumn("Element");
  man->CreateNtupleDColumn("Blank3");
  man->CreateNtupleDColumn("Edep");
  man->CreateNtupleDColumn("Time");
  man->CreateNtupleDColumn("Xpos");
  man->CreateNtupleDColumn("Ypos");
  man->CreateNtupleDColumn("Zpos");
  man->CreateNtupleDColumn("Blank4");
  man->CreateNtupleDColumn("Blank5");
  man->CreateNtupleDColumn("Blank6");
  man->CreateNtupleDColumn("ParentID");
  man->CreateNtupleDColumn("StepN");
  man->CreateNtupleDColumn("InitE");
  man->FinishNtuple();
  /*
  // ---- secondary ntuple ------   
  //id==2
