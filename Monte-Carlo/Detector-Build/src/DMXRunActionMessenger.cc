...
{ 
  ...
  SaveHistFileCmd = new G4UIcmdWithAString("/dmx/rootfile",this);
  SaveHistFileCmd->SetGuidance("output file for Ntuples");
  SaveHistFileCmd->SetGuidance("Default = dmx.root");
  //  SaveHistFileCmd->SetParameterName("savehistFile", false);
  SaveHistFileCmd->SetParameterName("histFile", false);
  SaveHistFileCmd->SetDefaultValue("dmx.root");
